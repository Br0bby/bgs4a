...
class Surface(object):
    def __init__(self, size, flags=0,
                 ...
                 ratio_x=1, ratio_y=1, canvas=None):
    ...
    def blit(self, source, dest, area=None, special_flags=0):
        if self.screen:
            print((source.width * self.ratio_x),
                  (source.height * self.ratio_y), self.ratio_x, self.ratio_y)
            self.screen.drawImage(source,
                                  dest[0]* self.ratio_x,
                                  dest[1]* self.ratio_y,
                                  source.width * self.ratio_x,
                                  source.height * self.ratio_y)
        return None
